...
namespace JourneysTest
{
    ...
    public static class JourneyFileReaderTests
    {
        ...
        {
            var journeys = JourneyFileReader.ParseJourneyFile(TestFiles, @"c:\testfile1").ToList();
        ...
        {
            var journeys = JourneyFileReader.ParseJourneyFile(TestFiles, @"c:\testfile2").ToList();
            var journey = journeys[0].AsJourney();
            var commands = journey.Commands.ToList();
        ...
        {
            var journeys = JourneyFileReader.ParseJourneyFile(TestFiles, @"c:\testfile3").ToList();
        ...
        {
            var parseResults = JourneyFileReader.ParseJourneyFile(TestFiles, @"c:\testfile4").ToList();
        ...
        {
            var parseResults = JourneyFileReader.ParseJourneyFile(TestFiles, @"c:\testfile5").ToList();
